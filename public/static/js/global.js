    ...
    this.shadowRoot.innerHTML = `
      ...
      <nav class="navbar">
        <div class="navbar-container">
          ...
          <ul class="nav-menu">
            <li><a href="${level}notas/" class="nav-link">Notas</a></li>
            <li><a href="${level}simuladores/" class="nav-link">Simuladores</a></li>
          </ul>
      ...
      <div class="mobile-menu" id="mobileMenu">
        ...
        <div class="mobile-menu-links">
            <a href="${level}notas/">Notas</a>
            <a href="${level}simuladores/">Simuladores</a>
        </div>
      </div>
    `
  }
